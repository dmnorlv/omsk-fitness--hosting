...
/*!****************************************!*\
  ...
  \****************************************/
/*! exports provided: initLazyImg */function(e,t,s){"use strict";s.r(t),s.d(t,"initLazyImg",(function(){return n}));var n=function(){var e=[].slice.call(document.querySelectorAll(".personal__list")),t=document.querySelectorAll(".personal__swiper-slide");if("IntersectionObserver"in window){var s=new IntersectionObserver((function(e){e.forEach((function(e){e.isIntersecting&&t.forEach((function(e){e.classList.add("visible")}))}))}));e.forEach((function(e){s.observe(e)}))}}},"./js/modules/navigation.js":
/*!**********************************!*\
  !*** ./js/modules/navigation.js ***!
  \**********************************/
/*! exports provided: initNav */function(e,t,s){"use strict";s.r(t),s.d(t,"initNav",(function(){return i}));var n=document.querySelector(".page-header__content-img-container"),a=document.querySelector(".page-header__nav"),r=document.querySelector(".page-header__links-wrapper"),i=function(){n.classList.add("page-header__content-img-container-js"),r.children.length>1&&(n.classList.remove("page-header__content-img-container-js"),a.classList.add("page-header__nav-js"))}},"./js/modules/personal.js":
/*!********************************!*\
  !*** ./js/modules/personal.js ***!
  \********************************/
/*! exports provided: initTranersSlider, initBackgrounds */function(e,t,s){"use strict";s.r(t),s.d(t,"initTranersSlider",(function(){return l})),s.d(t,"initBackgrounds",(function(){return r}));var n=s(/*! swiper */"../node_modules/swiper/swiper.esm.js"),a=s(/*! ../utils/utils */"./js/utils/utils.js"),r=function(){var e=document.querySelectorAll(".personal__swiper-slide"),t=new MutationObserver((function(e){e.forEach((function(e){e.target.classList.contains("visible")&&(e.target.addEventListener("mouseenter",(function(){var t=window.getComputedStyle(e.target).backgroundImage.match(/url.*/);e.target.style.backgroundImage="linear-gradient(90deg, rgba(16, 38, 84, 1) 0%, rgba(16, 38, 84, 0.89) 0%), ".concat(t[0])})),e.target.addEventListener("mouseleave",(function(){if(!e.target.classList.contains("focused")){var t=window.getComputedStyle(e.target).backgroundImage.match(/url.*/);e.target.style.backgroundImage="".concat(t[0])}})),e.target.onfocus=function(){var t=window.getComputedStyle(e.target).backgroundImage.match(/url.*/);e.target.classList.add("focused"),e.target.style.backgroundImage="linear-gradient(90deg, rgba(16, 38, 84, 1) 0%, rgba(16, 38, 84, 0.89) 0%), ".concat(t[0])},e.target.onblur=function(){var t=window.getComputedStyle(e.target).backgroundImage.match(/url.*/);e.target.classList.remove("focused"),e.target.style.backgroundImage="".concat(t[0])})}))})),s={attributes:!0};e.forEach((function(e){t.observe(e,s)}))},i=document.querySelector(".personal__button-prev"),o=document.querySelector(".personal__button-next"),l=function(){if(i&&o){var e=new n.default(".personal__swiper",{modules:[n.Navigation],rewind:!0,spaceBetween:40,slidesPerView:1,initialSlide:2,navigation:{nextEl:".personal__button-next",prevEl:".personal__button-prev"},breakpoints:{768:{slidesPerView:2,spaceBetween:30,initialSlide:2},1200:{initialSlide:0,slidesPerView:4,spaceBetween:40}}});i.addEventListener("keydown",(function(t){Object(a.isEnterKey)(t)&&(e.slidePrev(),i.classList.add("slider-btn-active"))})),i.addEventListener("keyup",(function(e){Object(a.isEnterKey)(e)&&i.classList.remove("slider-btn-active")})),o.addEventListener("keydown",(function(t){Object(a.isEnterKey)(t)&&(e.slideNext(),o.classList.add("slider-btn-active"))})),o.addEventListener("keyup",(function(e){Object(a.isEnterKey)(e)&&o.classList.remove("slider-btn-active")}))}}},"./js/modules/products-tabs.js":
/*!*************************************!*\
...
/*!***************************!*\
  !*** ./js/utils/utils.js ***!
  \***************************/
/*! exports provided: isSpaceKey, isEnterKey */function(e,t,s){"use strict";s.r(t),s.d(t,"isSpaceKey",(function(){return n})),s.d(t,"isEnterKey",(function(){return a}));var n=function(e){return" "===e.key},a=function(e){return"Enter"===e.key}}});